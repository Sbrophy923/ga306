...
#cube = cmds.polyCube(depth=130, subdivisionsX=170, subdivisionsY=150)
#arPolyNoise(cube[0], 0.04)
# stop the timer
timeStop = time.clock()
...
def create_car(name, length=6, width=3):
